...
@section('profiles')
    <div class="mt-4 mb-4 text-center">
        <h4 class="text-uppercase font-weight-bold f_personal_profile">Personal Information</h4>
    ...
    <div class="card shadow" style="font-size: 13px">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-6 flex_icon_edit">
                ...
                <div class="col-md-6">
                    <div class="row f_profile">
                        ...
                        <div class="col-7">
                            ...
                            <h6 class="m-0 text-nowrap f_email_wrap">
                                {{ Auth::user()->email }}
                            </h6>
