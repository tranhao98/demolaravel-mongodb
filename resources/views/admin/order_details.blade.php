                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <tr>
                                            <td>Order Total</td>
                                            <td>{{ number_format($ordersDetails['grandTotal'], 0, ',', '.') }} VNĐ</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan=2>
                                               <input type="hidden" value="{{$ordersDetails['_id']}}" class="idOrder"> 
                                                <select class="form-control" name="order_status" id="val-status">
                                                ...
                                                <button type="submit" class="btn btn-success form-control update-status">Update</button>
                                            </td>
                                        </tr>
                        ...
                        <div class="card-body table-responsive p-0">
                          <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td><img src="../../images/{{ $pro->products['urlHinh'] }}" alt="" width="70px" height="70px"></td>
